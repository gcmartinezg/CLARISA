...
export class CgiarEntityTypeMapper {
  ...
  public classToDtoV1(
    ...
    return this._basicCETDtoMapper.classToDtoV2(cgiarEntityType, showIsActive);
  }
  ...
  public classListToDtoV1List(
    ...
    return this._basicCETDtoMapper.classListToDtoV2List(
      cgiarEntityTypes,
      showIsActive,
    );
  }
  ...
  public classToDtoV2(
    ...
    Object.assign(
      cgiarEntityTypeDtoV2,
      this._basicCETDtoMapper.classToDtoV2(cgiarEntityType, showIsActive),
    );
    ...
    if (cgiarEntityType.funding_source_object) {
      cgiarEntityTypeDtoV2.funding_source = this._basicFSDtoMapper.classToDtoV2(
    ...
    if (cgiarEntityType.portfolio_object) {
      cgiarEntityTypeDtoV2.portfolio = this._basicPDtoMapper.classToDtoV2(
